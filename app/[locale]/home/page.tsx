...
export default function HomePage() {
  ...
  return (
    <div className={classes["dashboard-layout"]}>
      ...
      <div className={`${classes["dashboard__balance-container"]} ${classes["section-container"]}`}>
      ...
      <div className={classes["dashboard__history-transaction-container"]}>
        <div className={`${classes["dashboard__history-container"]} ${classes["section-container"]}`}>
        ...
        <div className={`${classes["dashboard__transaction-container"]} ${classes["section-container"]}`}>
